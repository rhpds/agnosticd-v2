...
[source,sh]
----
./tools/deployer_scripts/aad_v2 provision --guid myocp --config openshift-cluster --account sandbox1234
----
...
[source,sh]
----
./tools/deployer_scripts/aad_v2 provision -g myocp -c openshift-cluster -a sandbox1234
----
...
[source,sh]
----
./tools/deployer_scripts/aad_v2 destroy --guid myocp --config openshift-cluster --account sandbox1234
----
